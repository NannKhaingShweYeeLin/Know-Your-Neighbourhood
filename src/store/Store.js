    ...
    <div>
        ...
        <thead>
            <tr class="table-secondary">
                <td class="table-danger">Store Id</td>
                <td class="table-danger">Store Name</td>
                <td class="table-danger">Store Price</td>
                <td class="table-danger">Store Registration</td>
        ...
        <tbody>
            {
                this.state.stores.map(store => 
                    <tr class="table-secondary" key={store.storeId}>
                      <td class="table-secondary">{store.storeId}</td>
